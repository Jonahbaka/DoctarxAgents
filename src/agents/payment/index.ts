...
const mpesaStkPushSchema = z.object({
  ...
  transactionDesc: z.string().optional().default('DoctaRx Payment'),
});
...
const mtnMomoSchema = z.object({
  ...
  payerMessage: z.string().optional().default('DoctaRx Payment'),
      ...
      try {
        ...
        const resp = await fetch(`${baseUrl}/mpesa/stkpush/v1/processrequest`, {
          ...
          body: JSON.stringify({
            ...
            CallBackURL: `${CONFIG.doctarx.apiUrl}/webhooks/mpesa`,
      ...
      try {
        const resp = await fetch('https://api.flutterwave.com/v3/payments', {
          ...
          body: JSON.stringify({
            ...
            redirect_url: params.redirectUrl || `${CONFIG.doctarx.apiUrl}/webhooks/flutterwave`,
            meta: params.meta || {},
          }),
          signal: AbortSignal.timeout(15000),
        });
    ...
    execute: async (input, ctx) => {
      ...
      try {
        const body: Record<string, unknown> = {
          ...
          email: params.email,
          currency: params.currency,
          callback_url: params.callbackUrl || `${CONFIG.doctarx.apiUrl}/webhooks/paystack`,
        };
